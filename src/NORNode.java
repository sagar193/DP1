...
public class NORNode extends Node{
    ...
    public void update(Input input) {
        if(inputs[0] == input || inputs[1] == input){
            ...
            System.out.println("Error, NORGate krijgt een update van een node waaraan hij niet gekoppeld is");
        }
    }
    ...
    public void pair(Input newInput) {
        if (inputs[0] == null){
            ...
            System.out.println("Error, NORGate is vol en probeert een input erbij te zetten");
        }
        calculateValue();
    }
    ...
    public void unpair(Input oldInput) {
        if (inputs[0] == oldInput){
            ...
            System.out.println("Error, NORGate probeerd een input te unpairen die niet gepaired is");
        }
        calculateValue();
    }
